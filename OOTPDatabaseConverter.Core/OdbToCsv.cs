...
namespace OOTPDatabaseConverter.Core
{
    ...
    {
        #region Members
        private static string pathDelimeter = Utilities.FilePathDelimeter();
        ...
        public void Start(IProgress<Utilities.ProgressInfo> progress)
        {
            if (VerifyAllFiles() == true)
            {
                ...
                historicalDatabaseConverter.ToCsv(progress, currentDatabaseByte, combinedDatabaseFileSizes, fileNames.HistoricalDatabaseFileName);
                historicalMinorDatabaseConverter.ToCsv(progress, currentDatabaseByte += historicalDatabaseFileSize, combinedDatabaseFileSizes, fileNames.HistoricalMinorDatabaseFileName);
                historicalLineupsDatabaseConverter.ToCsv(progress, currentDatabaseByte += historicalMinorDatabaseFileSize, combinedDatabaseFileSizes, fileNames.HistoricalLineupsDatabaseFileName);
                historicalTransactionsDatabaseConverter.ToCsv(progress, currentDatabaseByte += historicalLineupsDatabaseFileSize, combinedDatabaseFileSizes, fileNames.HistoricalTransactionsDatabaseFileName);
